...
public class RobotsAndSociety extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_robots_and_society);
        ...
        txtQuestion = (TextView) findViewById(R.id.society);
        rda = (RadioButton) findViewById(R.id.sos1);
        rdb = (RadioButton) findViewById(R.id.sos2);
        rdc = (RadioButton) findViewById(R.id.sos3);
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((qid >= 15)&(qid <=19)) {
                    ...
                    Intent intent = new Intent(RobotsAndSociety.this, ResultActivity.class);
                    Bundle b = new Bundle();
    ...
    String[] msgArray = new String[] {"Robots in society"};
    ...
    protected void onStart() {
        ...
        textView = (TextView) findViewById(R.id.animation6);
